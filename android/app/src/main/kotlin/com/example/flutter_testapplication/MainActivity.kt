            ...
            .setMethodCallHandler { call, result ->
                when (call.method) {
                    ...
                    "getPitch" -> {
                        ...
                        result(mapOf("pitch" to pitch, "amplitude" to amplitude))
                    }
                    else -> result(null)
                }
            }
...
class AudioProcessor {
            ...
            while (isListening) {
                ...
                if (bytesRead > 0) {
                    ...
                    val rms = sqrt(audioBuffer.take(bytesRead)
                        .map { (it.toDouble() / 32768.0) * (it.toDouble() / 32768.0) }
                        .average())
    ...
    private fun detectPitch(signal: FloatArray): Double? {
        ...
        val minPeriod = (SAMPLE_RATE / 800).toInt() // Max frequency ~800 Hz
        val maxPeriod = (SAMPLE_RATE / 150).toInt() // Min frequency ~150 Hz
