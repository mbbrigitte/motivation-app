...
class _PostureChallengeState extends State<PostureChallenge> with TickerProviderStateMixin {
  ...
  void _initializeCards() {
    List<MemoryCard> cards = [
      MemoryCard(id: 0, content: 'Straight Back', type: CardType.text, pairId: 0),
      MemoryCard(id: 1, content: 'Good Posture', type: CardType.text, pairId: 0),
      MemoryCard(id: 2, content: 'Bow Hold', type: CardType.text, pairId: 1),
      MemoryCard(id: 3, content: 'Thumb Curved', type: CardType.text, pairId: 1),
      MemoryCard(id: 4, content: '🎻', type: CardType.emoji, pairId: 2),
      MemoryCard(id: 5, content: 'Violin', type: CardType.text, pairId: 2),
      MemoryCard(id: 6, content: 'Shoulder Rest', type: CardType.text, pairId: 3),
      MemoryCard(id: 7, content: 'Support', type: CardType.text, pairId: 3),
      MemoryCard(id: 8, content: 'Relaxed Shoulders', type: CardType.text, pairId: 4),
      MemoryCard(id: 9, content: 'No Tension', type: CardType.text, pairId: 4),
    ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('The Posture Challenge'),
