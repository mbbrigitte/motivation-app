...
class _ListeningChallengeState extends State<ListeningChallenge> with TickerProviderStateMixin {
  ...
  void _initializeCards() {
    List<MemoryCard> cards = [
      MemoryCard(id: 0, content: 'Forte', type: CardType.text, pairId: 0),
      MemoryCard(id: 1, content: 'Loud', type: CardType.text, pairId: 0),
      MemoryCard(id: 2, content: 'Piano', type: CardType.text, pairId: 1),
      MemoryCard(id: 3, content: 'Soft', type: CardType.text, pairId: 1),
      MemoryCard(id: 4, content: 'Crescendo', type: CardType.text, pairId: 2),
      MemoryCard(id: 5, content: 'Getting Louder', type: CardType.text, pairId: 2),
      MemoryCard(id: 6, content: 'Diminuendo', type: CardType.text, pairId: 3),
      MemoryCard(id: 7, content: 'Getting Softer', type: CardType.text, pairId: 3),
      MemoryCard(id: 8, content: '🎵', type: CardType.emoji, pairId: 4),
      MemoryCard(id: 9, content: 'Musical Note', type: CardType.text, pairId: 4),
    ];
    ...
    return Container(
      ...
      child: Center(
        child: Text(
          card.content,
          style: TextStyle(
            fontSize: card.type == CardType.emoji ? 50 : 22,
            fontWeight: FontWeight.bold,
